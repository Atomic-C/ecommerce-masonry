...
namespace Masonry_Data_Access.Migrations
{
    ...
    [Migration("20211218030007_addedprodcounter")]
    partial class addedprodcounter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Masonry_Models.InquiryDetails", b =>
                {
            ...
            modelBuilder.Entity("Masonry_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Masonry_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Masonry_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Masonry_Models.InquiryDetails", b =>
                {
                    b.HasOne("Masonry_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Masonry_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Masonry_Models.InquiryHeader", b =>
                {
                    b.HasOne("Masonry_Models.ApplicationUser", "Application")
                        .WithMany()
            ...
            modelBuilder.Entity("Masonry_Models.OrderDetail", b =>
                {
                    b.HasOne("Masonry_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Masonry_Models.OrderHeader", b =>
                {
                    b.HasOne("Masonry_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
